...
if (!estActifOuPasDoNotTrackHeader()) {
    ...
    echo " <p>Si vous le souhaitez vous pouvez utiliser le&nbsp;<a href='https://tools.google.com/dlpage/gaoptout/' target='_blank'>module complémentaire de désactivation</a>&nbsp;de Google&nbsp;Analytics pour le Web.</p>"
        ."</input>";
