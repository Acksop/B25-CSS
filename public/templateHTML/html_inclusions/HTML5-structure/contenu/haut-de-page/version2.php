 ...
 echo <<<EOF
		...
		function selectionnerDIVimage(elem){
			if ( document.getElementById && document.getElementById( elem ) ){
			    ...
			    // Pour les trés vieilles versions
...
EOF;
	...
	echo "\n		<li><a href='".link_rewrite('dossiers')."' >Dossiers</a></li>";
	...
	if(!isset($_SESSION['id_utilisateur'])){
		echo "<li>
    		   <div id='compte_btn'>
    		    ...
    		    <!-- <div href='#' class='infobulle'>-->
    		              <div id='aep' name='compte_btn' class='aep' style='display:none;'>
		...
		echo "<li>Bonjour <a href='".link_rewrite('compte')."'>".$_SESSION['identifiant']."</a>&nbsp;&nbsp;&nbsp;&nbsp;";
				if( !$mobile ){
				echo "//&nbsp;&nbsp;&nbsp;&nbsp;"
						."<a href='".link_rewrite('preferences')."'>Mes Pr&eacute;f&eacute;rences d'affichage(s)</a>"
						 ."&nbsp;&nbsp;&nbsp;&nbsp;//&nbsp;&nbsp;&nbsp;&nbsp;"
						."<a href='".link_rewrite('traitementDeconnexion',true)."'>Se D&eacute;connecter</a>";
				}
				echo "</li>";
	}
	if( !$mobile ){
